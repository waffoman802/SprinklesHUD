...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"134 11 230 255" // Active window bg color
		"G_InctiveWindow"			"61 61 61 255" // Inactive window bg color
		"G_TitleBg"					"203 203 203 0" // Title bg color
		"G_TitleText"				"7 7 7 255" // Title text color
		"G_Highlight"				"0 0 0 255" // Highlight color
		"G_ConsoleBg"				"61 61 61 255" // Console bg color
		"G_ListBg"					"255 255 255 255" // List bg color
		"G_Border"					"0 0 0 50" // Border color
		"G_Text"					"7 7 7 255" // Text color
		"G_HighlightText"			"255 255 255 255" // Highlight text color
		"G_SelectedText"			"255 255 255 255" // Selected text color
		"G_DisabledText"			"122 122 122 255" // Disabled text color
		"G_ButtonBg"				"61 61 61 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"233 122 90 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_InputBg"					"222 222 222 255" // Input bg color
