Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"160 22 165 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"61 61 61 255" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"0 238 10 255" // Heal color
		"G_Hit"					"160 22 165 255" // Hit color
		...
		"G_LightGrey"			"213 213 213 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"160 22 165 156" // Transparent menu color
		"G_PanelBg"				"160 22 165 156" // Panel color
		"G_OpaquePanelBg"		"160 22 165 255" // Opaque Panel color
		"G_Warning"				"7 7 7 255" // Warning color
		"G_HealthValue"			"160 22 165 255" // Health value color
		"G_Overheal"			"0 238 10 255" // Overhealed health value color
		"G_LowHealthValue"		"250 35 35 255" // Low health value color
		"G_AmmoClipValue"		"178 31 223 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"160 22 165 255" // Ammo in reserve value color
		"G_LowAmmo"				"255 0 0 255" // Low ammo color
		"G_MetalValue"			"213 213 213 255" // Metal color
		"G_MetalIcon"			"213 213 213 255" // Metal icon color
		"G_HeadsValue"			"0 238 10 255" // Heads value color
		"G_HeadsLabel"			"0 238 10 255" // Heads value icon color
		"G_KillstreakValue"		"250 35 35 255" // Killstreak value color
		"G_KillstreakIcon"		"250 35 35 255" // Killstreak icon color
		"G_StickyColor"					"160 22 165 255" // Stickybomb color
		"G_StickyIconColor"				"213 213 213 255" // Stickybomb icon color
		"G_CustomTargetID" 				"7 7 7 204" // Custom target id bg color
		...
		"G_Killfeed_Base"			"0 0 0 179" // Killfeed Base color
		...
		"G_Footer"					"48 33 61 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"168 168 168 255" // Footer text color
		"G_DimmFooterText"			"168 168 168 120" // Dimm Footer text color
		"G_OuterBorder"				"0 0 0 51" // Outer border color
		"G_InnerBorder"				"0 0 0 26" // Inner border color
		"G_KillfeedBlue"			"178 31 223 255" // Killfeed blue text
		...
		"G_MainMenuOverlay"			"31 37 50 204" // Main Menu overlay color
		"G_MainMenuButton"			"134 11 230 255" // Main Menu button color
		"G_MainMenuButtonHover"		"121 121 121 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"232 232 232 255" // Main Menu button text color
		"G_MainMenuButtonHoverFg"	"245 245 245 255" // Main Menu hovered button text color
		"G_BackpackItemBg"			"255 255 255 255" // Backpack item bg color
		"G_LoadoutItemBg"			"61 61 61 255" // Loadout item bg color
		"G_MenuBg"					"213 213 213 255" // Menu bg color
		"G_MenuText"				"7 7 7 255" // Menu text color
		"G_InputText"				"213 213 213 255" // Input text color
		"G_DimmInputText"			"213 213 213 100" // Dimm Input text color
		"G_DimmMenuText"			"7 7 7 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"7 7 7 255" // Item description panel bg
		"G_ButtonBg"				"133 11 229 255" // Button bg color
		"G_ButtonText"				"232 232 232 255" // Button text color
		"G_ButtonHoverBg"			"163 90 233 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"7 7 7 255" // Button selected bg color
		"G_ButtonSelectedText"		"170 170 170 255" // Button selected text color
		...
		"G_ItemMeterBg"				"7 7 7 255" // Item meter bg
		"G_ItemMeterBorder"			"0 0 0 0" // Item meter border color
		"G_MenuShader"				"203 203 203 255" // Menu shader color
		"G_ItemEffectMeterLineColor"	"120 120 120 130"
		"G_MvmLobbyPanelBg"			"40 40 40 255"
		"G_MvmLobbyPanelText"		"220 220 220 255"
		
		// Crosshairs
		"G_Crosshair1Color"		"160 22 165 255" // Crosshair1 color
		"G_Crosshair2Color"		"178 31 223 255" // Crosshair2 color
		"G_Crosshair3Color"		"250 35 35 255" // Crosshair3 color
		...
		"TFOrange"			"160 22 165 255" // Highlight color
		...
		"QualityColorStrange"					"233 122 90 255" // IQC Strange
		...
		"DimmQualityColorStrange"				"233 122 90 100" // Dimm IQC Strange
	...
	BaseSettings
	{
		...
		Slider.NobColor				"160 22 165 255" // Highlight color
		Slider.TextColor			"7 7 7 255" // Menu text color
		Slider.TrackColor			"7 7 7 255" // Menu text color
		Slider.DisabledTextColor1	"7 7 7 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"7 7 7 120" // Dimm Menu text color
